...
export const info = {
    firstName: "Fanny",
    lastName: "Schlag",
    initials: "Mrs.", // the example uses first and last, but feel free to use three or more if you like.
    position: "a Goldsmith in the making",
    ...
    miniBio: [ // these are just some "tidbits" about yourself. You can look at mine https://paytonjewell.github.io/#/ for an example if you'd like
        {
            emoji: '☕',
            text: 'fueled by art, designing ornaments and travelling'
        },
        {
            emoji: '🌎',
    ...
    socials: [
        ...
        // },
        {
            link: "https://www.instagram.com/fanny.schlag/",
...
// Just change the links so that they lead to your social profiles.
    ...
    bio: "Hello! I'm Fanny, currently pursuing Bachelors in .... I'm a Goldsmith in the making, with a passion for designing ornaments and travelling. I'm based in Germany and I'm self-employed. I'm always open to new opportunities, so feel free to reach out to me at",
     skills:
        {
            proficientWith: ['Gold based ornament making'],
            exposedTo: ["Gold based", 'Silver based', 'Copper based', 'Bronze based', 'Platinum based', 'Titanium based', ]
        }
    ,
    hobbies: [
        {
